...
DEFAULT_SOURCES = [
    # HuggingFace datasets for AI/code knowledge
    {"type": "hf_dataset", "config": {"repo": "Open-Orca/OpenOrca", "limit": 200}},
    {"type": "hf_dataset", "config": {"repo": "databricks/databricks-dolly-15k", "limit": 200}},
    {"type": "hf_dataset", "config": {"repo": "GAIR/lima", "limit": 100}},
    # Code-related GitHub repos (skeleton, can be added by user)
    ...
    # Self-training: generate Q&A from existing KB
    {"type": "self_train", "config": {"rounds": 50, "per_round": 5}},
    # OPERATIONAL TRAINING: make Hermes actually USE its skills
    # Generate usage examples for every existing skill (5 per skill = ~475 examples)
    {"type": "skill_usage_train", "config": {"per_skill": 5}},
    # Improve skill descriptions + triggers for better semantic matching
    {"type": "skill_index_rebuild", "config": {}},
    # Distill recent lessons into new system-prompt rules
